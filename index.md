...
venue: "University College Dublin"        # brief name of host site without address (e.g., "Euphoric State University")
address: "James Joyce Library, UCD Belfield Campus, Dublin, Ireland"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "53.306857,-6.223089"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "24-25 June 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Anne Other", "Jo Bloggs"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["lirgroup@example.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
